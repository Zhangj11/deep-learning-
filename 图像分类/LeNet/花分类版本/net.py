...
class MyLeNet5(nn.Module):
    ...
    def __init__(self,num_classes):
        ...
        #输入大小为28*28，输出大小为28*28,输入通道为1，输出为6，卷积核大小为5,步长为1,p=2
        ...
        self.output = nn.Linear(84,num_classes)#修改
...
if __name__=="__main__":
    x = torch.rand([1,3,28,28])#任意产生一个张量,批次1，通道为1，大小为28*28
    model = MyLeNet5(num_classes=5)#网络实例化
    y = model(x) #输出结果
    print(y)
    # 统计模型参数,total param num 61581
    # sum = 0
